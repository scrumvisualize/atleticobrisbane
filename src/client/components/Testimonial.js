...
const testimonials = [
  {
    name: 'Noby Thomas',
    text: 'My two kids enjoy playing at Atletico Soccer Club. This club is friendly and has been amazing for my kids. Everyone is supportive, and the environment is fantastic!',
  },
  {
    name: 'Haju Thomas',
...
const Testimonials = () => {
  return (
    <div className="py-12 bg-gradient-to-r from-blue-100 to-pink-100">
